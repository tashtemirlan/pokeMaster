...
class BattleContestBottomSheetScreen extends StatefulWidget{
  ...
  final bool isMaster;
  final Region region;
  const BattleContestBottomSheetScreen({super.key, required this.pokemonListMasters,
    required this.pokeAwards, required this.isMaster, required this.region});

  @override
  BattleContestBottomSheetScreenState createState() => BattleContestBottomSheetScreenState();
}

class BattleContestBottomSheetScreenState extends State<BattleContestBottomSheetScreen> with TickerProviderStateMixin {
  ...
  Future<void> registerBadgeChallenge() async{
    ...
    if(widget.isMaster == true){
      ...
      if(indexAwardsWhere !=-1){
        ...
        //update data =>
        box.put("PokeContestBigFestival", pokeMasterList);
      }
    }
    else{
      //just casual gym :
      ...
      if(widget.region == Region.Kanto){
        ...
        //update data =>
        box.put("PokeContest", pokeListFromHive);
      }
